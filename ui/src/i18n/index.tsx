...
const messages: Record<SupportedLanguage, Record<string, string>> = {
  'zh-CN': {
    'app.subtitle': '连接、自动化与诊断一体化控制台',
    'app.workspaceKicker': 'Workspace',
    ...
    'nav.section': '工作区',
    'nav.cockpit': '驾驶舱',
    'nav.cockpit.description': '连接状态、快捷控制与健康提示',
    'nav.devices': '设备库',
    'nav.devices.description': '当前设备与已记住设备资产',
    'nav.automation': '自动连接',
    'nav.automation.description': '自动连接规则与优先级',
    'nav.diagnostics': '诊断支持',
    'nav.diagnostics.description': '导出支持包与运行态排障',
    'nav.preferences': '偏好设置',
    'nav.preferences.description': '主题、语言、通知与启动设置',
    'command.refreshDevices': '刷新设备',
    'cockpit.kicker': 'Connection cockpit',
    'cockpit.title': '连接驾驶舱',
    'cockpit.description': '围绕当前连接、候选设备和恢复线索组织高频操作。',
    'cockpit.openDiagnostics': '前往诊断支持',
    'cockpit.recoveryTitle': '恢复与异常摘要',
    'cockpit.health.available.title': '音频路径健康',
    'cockpit.health.available.description': '当前已找到可用音频设备，可以直接在这里继续控制连接。',
    'cockpit.health.no-source.title': '未命中可用音频路径',
    'cockpit.health.no-source.description': '桥接存在，但还没有匹配到可把音频投到本机的远端设备。',
    'cockpit.health.unavailable.title': '桌面桥接不可用',
    'cockpit.health.unavailable.description': '当前运行环境无法访问原生桌面桥接，建议转到诊断支持查看详情。',
    'overview.title': '连接总览',
    ...
    'devices.libraryKicker': 'Device library',
    'devices.title': '设备库',
    'devices.description': '把实时可操作设备与已记住设备资产分开展示，减少操作干扰。',
    ...
    'devices.history.delete.action': '删除历史',
    'devices.history.delete.confirm': '确认删除',
    'devices.history.delete.label': '删除 {name} 的历史记录',
    'devices.history.delete.confirmLabel': '确认删除 {name} 的历史记录',
    'devices.history.clear.action': '清空历史',
    'devices.history.clear.confirm': '确认清空',
    'devices.history.clear.label': '清空设备历史',
    'devices.history.clear.confirmLabel': '确认清空设备历史',
  ...
  'automation.appearRule': '{name} 再次出现或异常断联后自动连接',
    ...
    'diagnostics.description': '统一查看支持包、运行指标、错误摘要和 A2DP 细节。',
    'diagnostics.runtimeTitle': '运行态摘要',
    'diagnostics.audioRoutingTitle': '音频路由验证',
    ...
    'settings.diagnostics.audioRouting.currentDevice': '当前验证设备：{value}',
    'settings.diagnostics.audioRouting.remoteContainer': '远端 ContainerId：{value}',
    'settings.diagnostics.audioRouting.remoteConnected': '远端已连接：{value}',
    'settings.diagnostics.audioRouting.remotePresent': '远端仍在场：{value}',
    'settings.diagnostics.audioRouting.localRender': '本机播放端点：{value}',
    'settings.diagnostics.audioRouting.localRenderState': '本机播放端点状态：{value}',
    'settings.diagnostics.audioRouting.audioFlowObserved': '已观测到音频流：{value}',
    'settings.diagnostics.audioRouting.audioFlowPeak': '最近峰值：{value}',
    'settings.diagnostics.audioRouting.validationPhase': '验证阶段：{value}',
    'settings.diagnostics.audioRouting.lastValidatedAt': '最近验证时间：{value}',
    'settings.diagnostics.audioRouting.lastRecoverReason': '最近恢复原因：{value}',
  ...
  'en-US': {
    'app.subtitle': 'Unified cockpit for connection, automation, and diagnostics',
    'app.workspaceKicker': 'Workspace',
    ...
    'common.on': 'On',
    'common.off': 'Off',
    'nav.section': 'Workspaces',
    'nav.cockpit': 'Cockpit',
    'nav.cockpit.description': 'Connection state, quick controls, and health',
    'nav.devices': 'Devices',
    'nav.devices.description': 'Live devices and remembered device assets',
    'nav.automation': 'Automation',
    'nav.automation.description': 'Auto-connect rules and priority order',
    'nav.diagnostics': 'Diagnostics',
    'nav.diagnostics.description': 'Support bundle export and runtime troubleshooting',
    'nav.preferences': 'Preferences',
    'nav.preferences.description': 'Theme, language, notifications, and startup',
    'command.refreshDevices': 'Refresh Devices',
    'cockpit.kicker': 'Connection cockpit',
    'cockpit.title': 'Connection cockpit',
    'cockpit.description': 'Keep the highest-frequency connection actions, candidates, and recovery signals in one place.',
    'cockpit.openDiagnostics': 'Open diagnostics workspace',
    'cockpit.recoveryTitle': 'Recovery and exception summary',
    'cockpit.health.available.title': 'Audio path healthy',
    'cockpit.health.available.description': 'A usable audio path is currently available, so you can keep controlling the connection from here.',
    'cockpit.health.no-source.title': 'No matched audio path yet',
    'cockpit.health.no-source.description': 'The bridge is available, but there is no matched remote device ready to stream audio to this machine.',
    'cockpit.health.unavailable.title': 'Desktop bridge unavailable',
    'cockpit.health.unavailable.description': 'The native desktop bridge is unavailable in this runtime. Open diagnostics for the underlying detail.',
    ...
    'devices.libraryKicker': 'Device library',
    'devices.title': 'Device Library',
    'devices.description': 'Separate live controls from remembered device assets to keep the workspace focused.',
    ...
    'devices.history.delete.action': 'Delete history',
    'devices.history.delete.confirm': 'Confirm delete',
    'devices.history.delete.label': 'Delete {name} history',
    'devices.history.delete.confirmLabel': 'Confirm delete {name} history',
    'devices.history.clear.action': 'Clear history',
    'devices.history.clear.confirm': 'Confirm clear',
    'devices.history.clear.label': 'Clear device history',
    'devices.history.clear.confirmLabel': 'Confirm clear device history',
  ...
  'automation.appearRule': 'Auto-connect {name} after reappear or abnormal disconnect',
    ...
    'diagnostics.kicker': 'Diagnostics',
    'diagnostics.description': 'Review support bundles, runtime metrics, error summaries, and A2DP details in one workspace.',
    'diagnostics.runtimeTitle': 'Runtime summary',
    'diagnostics.audioRoutingTitle': 'Audio routing validation',
    'preferences.kicker': 'Preferences',
    ...
    'settings.diagnostics.audioRouting.currentDevice': 'Current validation device: {value}',
    'settings.diagnostics.audioRouting.remoteContainer': 'Remote container ID: {value}',
    'settings.diagnostics.audioRouting.remoteConnected': 'Remote connected: {value}',
    'settings.diagnostics.audioRouting.remotePresent': 'Remote present: {value}',
    'settings.diagnostics.audioRouting.localRender': 'Local render endpoint: {value}',
    'settings.diagnostics.audioRouting.localRenderState': 'Local render state: {value}',
    'settings.diagnostics.audioRouting.audioFlowObserved': 'Audio flow observed: {value}',
    'settings.diagnostics.audioRouting.audioFlowPeak': 'Latest peak: {value}',
    'settings.diagnostics.audioRouting.validationPhase': 'Validation phase: {value}',
    'settings.diagnostics.audioRouting.lastValidatedAt': 'Last validated at: {value}',
    'settings.diagnostics.audioRouting.lastRecoverReason': 'Last recover reason: {value}',
    ...
    'window.hideToTray': 'Hide window to tray',
    'tray.title': 'Cockpit quick controls',
