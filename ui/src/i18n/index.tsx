...
const messages: Record<SupportedLanguage, Record<string, string>> = {
  'zh-CN': {
    ...
    'automation.description': '配置触发策略与回退顺序。',
    'automation.appearRule': '当该设备出现时自动连接',
    'automation.priority': '优先队列',
    ...
    'settings.updates': '更新',
    'settings.updates.hint': '检查更新保留给安装器渠道。',
  ...
  'en-US': {
    ...
    'automation.description': 'Configure trigger strategy and fallback order.',
    'automation.appearRule': 'Auto-connect when this device appears',
    'automation.priority': 'Priority Queue',
    ...
    'settings.updates.hint': 'Check for updates is reserved for the installer channel.',
